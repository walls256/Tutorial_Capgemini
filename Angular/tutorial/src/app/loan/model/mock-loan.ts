...
export const LOAN_DATA: LoanPage = {
    content: [
        ...
        { id: 5, client: { id: 5, name: 'Client 5' }, game: { id: 1, title: 'Juego 1', age: 6, category: { id: 1, name: 'Categoría 1' }, author: { id: 1, name: 'Autor 1', nationality: 'Nacionalidad 1' } }, startDate: new Date("2024-02-14"), endDate: new Date("2024-02-25")},
    ],  
    pageable : {        
        pageSize: 5,
        pageNumber: 0,
